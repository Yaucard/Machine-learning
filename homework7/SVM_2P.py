     ...
     for f in files:         ##將路徑底下的檔名與路徑結合
         ...
         if isfile(allpath):
             ...
             for n in range(0,len(target_record["scene_info"])):
                 ...
                 PlatformPosition_2P.append(target_record["scene_info"][n]["platform_2P"])
#-----------------------------------------------------------------------------------------------------------------------------------#
##############################################################################
     PlatX = np.array(PlatformPosition_2P) [:,0][:,np.newaxis]          #板子的X位子
...
#--------------------------- train model
     ...
     print("R2=",R2)
#-----------------------------------------------------------------------------------------------------------------------------------#
     filename = "C:\\Users\\USER\\Desktop\\W3_6_8\\zxc1263426\\MLGame-master\\games\\pingpong\\ml\\SVM_2P_20210105.sav"
